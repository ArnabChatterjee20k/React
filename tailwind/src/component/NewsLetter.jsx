    ...
    return (
        <div className="w-full py-16 text-white">
            <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3">
                <div className="lg:col-span-2 my-4">{/* take 2 out of 3 columns */}
                    <h1 className="text-2xl md:text-4xl md:py-2 sm:text-3xl font-bold">Want tips and tricks to optimise your flow?</h1>
